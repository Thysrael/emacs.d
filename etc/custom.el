(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window auctex auto-dim-other-buffers beginend blamer breadcrumb cal-china-x cape cdlatex
                chatgpt-shell cns code-cells consult-dir consult-eglot consult-org-roam
                corfu-terminal cuda-mode diff-hl diredfl dirvish doom-themes dts-mode dumb-jump eaf
                eglot-booster embark-consult embrace engrave-faces esup gcmh gnuplot gnuplot-mode
                hl-todo indent-bars kconfig-mode lua-mode magit marginalia markdown-mode meow-vterm
                mwim nerd-icons-completion nerd-icons-corfu no-littering orderless org-appear
                org-autolist pangu-spacing pinyinlib popper puni quickrun rainbow-delimiters
                rainbow-mode rime rust-mode scala-mode sdcv shackle sis sudo-edit symbol-overlay
                tempel treesit-auto typescript-mode vertico visual-fill-column vterm vundo wgrep
                ws-butler yaml-mode))
 '(package-vc-selected-packages
   '((advance-words-count :url "https://github.com/Thysrael/advance-words-count"))))
(custom-set-faces
